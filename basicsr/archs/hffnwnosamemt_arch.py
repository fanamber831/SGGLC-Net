...
from basicsr.archs.emt import MixedTransformerBlock
from basicsr.archs.utils import Swish
...
class HFFBlock(nn.Module):
    def __init__(self,wn,n_feat):
        ...
        self.emt=MixedTransformerBlock(wn,dim=self.channel, num_layer=2, num_heads=3, num_GTLs=2,
