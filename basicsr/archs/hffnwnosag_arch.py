...
from basicsr.archs.omnisr import OSA_Block
...
class LFFB(nn.Module):
    def __init__(self,wn,n_feat):
        ...
        self.conv1=wn(nn.Conv2d(n_feat*3,n_feat,1,groups=3))
