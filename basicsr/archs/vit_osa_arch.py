...
from basicsr.archs.efficientvit import EfficientViTBlock
...
class HFFB(nn.Module):
    def __init__(self, wn, n_feat):
        ...
        self.dwconv = wn(nn.Conv2d(self.channels_3, self.channels_3, kernel_size=3,
                         stride=1, padding=1, bias=False, groups=self.channels_3))
...
class HFFNET_vit(nn.Module):
    def __init__(self, num_in_ch=3, n_feats=48, upscale=2, conv=default_conv):
        ...
        self.vit_block = EfficientViTBlock('s', n_feat, n_feat)
